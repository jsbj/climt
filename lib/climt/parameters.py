...
class Parameters:
    ...
    def _setDefaults(self):
        ...
        self.append('tauaer_sw', None, '-', 'Aerosol optical depth')
        self.append('ssaaer_sw', None, '-', 'Aerosol single scattering albedo')
        self.append('asmaer_sw', None, '-', 'Aerosol asymmetry parameter')
        self.append('tauaer_lw', None, '-', 'Aerosol optical depth')
